export const experiences = [
  {
    ...
    points: [
      ...
      "Debugged and resolved high-priority, mission-critical backend issues to ensure system reliability.",
      "Developed and maintained scalable front-end components using React & TypeScript.",
      "Worked alongside UX/UI designers to improve functionality  & optimize user interactions.",
      "Developed and maintained backend services using .NET & C# to support high-volume LiDAR data processing.",
      "Designed and optimized data models for structured storage.",
      "Built and maintained RESTful APIs for seamless integration between web applications and backend data processing services.",
      "Implemented and enhanced ETL data pipelines for automated acquisition and approval workflows.",
    ],
  },
  {
