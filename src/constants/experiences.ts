export const experiences = [
  {
    ...
    points: [
      ...
      "Developed and maintained scalable backend services using .NET & C# to support high-volume LiDAR data processing and visualization.",
      "Designed and optimized data models for structured storage, improving retrieval efficiency for large datasets.",
      "Built and maintained RESTful APIs for seamless integration between web applications and backend data processing services, ensuring cross-platform consistency.",
